...
},{"core-js/shim":"node_modules/core-js/shim.js","regenerator-runtime/runtime":"node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"node_modules/core-js/fn/regexp/escape.js"}],"node_modules/parcel/src/builtins/_empty.js":[function(require,module,exports) {
...
var svg = "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 48 48\"><g fill=\"none\" fill-rule=\"evenodd\"><path d=\"M0 0h48v48H0z\"/><path d=\"M11 37h8v6h-9c-2.762 0-5-2.238-5-5v-9h6v8zm0-26v8H5v-9c0-2.762 2.238-5 5-5h9v6h-8zm26 0h-8V5h9c2.762 0 5 2.238 5 5v9h-6v-8zm0 26v-8h6v9c0 2.762-2.238 5-5 5h-9v-6h8zM24 15c4.972 0 9 4.028 9 9s-4.028 9-9 9-9-4.028-9-9 4.028-9 9-9zm0 12c1.658 0 3-1.342 3-3s-1.342-3-3-3-3 1.342-3 3 1.342 3 3 3z\" stroke-opacity=\".698\" stroke=\"#000\" stroke-width=\"2\" fill=\"#FFF\" fill-rule=\"nonzero\"/></g></svg>";
var closeSvg = "<svg version=\"1.0\" viewBox=\"0 0 24 24\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm4.9 13.5l-1.4 1.4-3.5-3.5-3.5 3.5-1.4-1.4 3.5-3.5-3.5-3.5 1.4-1.4 3.5 3.5 3.5-3.5 1.4 1.4-3.5 3.5 3.5 3.5z\"/></svg>";
var defaultLat = 35.6762;
var defaultLng = 139.6503;
var defaultZoom = 10;
var defaultStyle = 'geolonia/basic';
var html = '<div class="geolonia" data-lat=":lat" data-lng=":lng" data-zoom=":zoom" data-style=":style"></div>';

require("_bundle_loader")(require.resolve('./style.scss')).then(function () {
  var btn = document.getElementById('get-geolonia');
  btn.addEventListener('click', function () {
    ...
    codeContainer.textContent = html.replace(':lat', defaultLat).replace(':lng', defaultLng).replace(':zoom', defaultZoom).replace(':style', defaultStyle);
    ...
    close.addEventListener('click', function () {
      var outer = document.getElementById('geolonia-map-outer-container');
    ...
    var map = new geolonia.Map('.map-container');
    map.on('moveend', function () {
      var center = map.getCenter().toArray();
      var zoom = map.getZoom();
      codeContainer.textContent = html.replace(':lat', center[1]).replace(':lng', center[0]).replace(':zoom', zoom);
    });
  });
});
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js","fs":"node_modules/parcel/src/builtins/_empty.js","_bundle_loader":"node_modules/parcel/src/builtins/bundle-loader.js","./style.scss":[["style.97fcb138.css","style.scss"],"style.97fcb138.css.map","style.97fcb138.js","style.scss"]}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
var b=require("node_modules/parcel/src/builtins/bundle-loader.js");b.register("js",require("node_modules/parcel/src/builtins/loaders/browser/js-loader.js"));b.register("css",require("node_modules/parcel/src/builtins/loaders/browser/css-loader.js"));
